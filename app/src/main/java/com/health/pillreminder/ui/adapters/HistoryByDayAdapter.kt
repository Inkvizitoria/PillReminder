...
class HistoryByDayAdapter(emptyList: List<Any>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    inner class IntakeCardViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(item: HistoryIntakeItem) {
            ...
            btnDelete.setOnClickListener {
                // TODO: Реализовать удаление записи из истории и обновление списка
            }
        }
    }
}
